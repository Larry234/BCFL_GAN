...
if __name__ == '__main__':
    ...
    for round in range(1, rounds + 1):
        ...
        contract_ins.functions.upload_model(gen_hs, round, group_id).transact()
        ...
        if aggreator_id == id:
            ...
            G_hs = contract_ins.functions.fetch_model(round, group_id).call()
            ...
            contract_ins.functions.upload_globalModel(GG_hs, round, group_id).transact()
        ...
        if id in validators:
            ...
            valid = True
            global_gen = contract_ins.functions.fetch_global_model(round, group_id).call()
